...
> **Estado: vigente** desde 2026-08-11 (spec-0033). Supersede a
> [`docs-as-code-likec4.md`](./docs-as-code-likec4.md), que rigió entre 2026-07-24 y esa
> fecha.
>
> Este documento es el **contrato de formato** de la documentación del repositorio: las
> plantillas de acá son las que siguen los 44 flujos y los 6 diagramas de componentes, y
> las que `/design` aplica al documentar un caso de uso nuevo.
