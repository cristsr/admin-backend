...
/**
 * Read-model tables for EP-3 (adapted from spec §6.2 / the EP-3 plan DDL). No
 ...
 */
export class CreateReconciliationProjections1784160000010 implements MigrationInterface {
  name = 'CreateReconciliationProjections1784160000010';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE TABLE "proj_transfer_candidates" (
        ...
        "user_id"             uuid NOT NULL,
        "outgoing_txn_id"     uuid NOT NULL,
        "incoming_txn_id"     uuid NOT NULL,
    ...
    `);
    await queryRunner.query(`
      CREATE INDEX "idx_transfer_candidates_user"
        ON "proj_transfer_candidates" ("user_id", "detected_at")
    `);
    await queryRunner.query(`
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP TABLE "proj_transfer_candidates"`);
