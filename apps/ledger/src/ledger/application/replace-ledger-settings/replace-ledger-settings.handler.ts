...
import { CurrencyCode, IanaTimeZone } from '@ledger/settings/domain/ledger-settings/value-objects';
import { ReplaceLedgerSettingsCommand } from './replace-ledger-settings.command';

/**
 * Replaces the ledger's presentation currency and timezone (RF-2).
 *
 ...
 * currency changed and the timezone did not (§3.5). The aggregate stays silent
