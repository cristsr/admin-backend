...
const THRESHOLDS_BY_SEVERITY = [BudgetThreshold.EXCEEDED, BudgetThreshold.WARNING];
...
export class Budget {
  ...
  claimThresholdBreach(): Nullable<BudgetThreshold> {
    ...
    const notifiedRank = this.notifiedThreshold ? THRESHOLD_RANK[this.notifiedThreshold] : 0;
