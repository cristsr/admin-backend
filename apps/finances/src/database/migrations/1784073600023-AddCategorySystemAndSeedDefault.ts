...
export class AddCategorySystemAndSeedDefault1784073600023 implements MigrationInterface {
  name = 'AddCategorySystemAndSeedDefault1784073600023';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "categories" ADD "system" boolean NOT NULL DEFAULT false`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DELETE FROM "categories" WHERE "system" = true AND "name" = 'Sin categorizar'`);
