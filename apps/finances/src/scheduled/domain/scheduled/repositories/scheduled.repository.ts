...
import { ScheduledField } from '../criteria/scheduled-field.type';
import { Scheduled } from '../entities/scheduled.entity';
...
export abstract class ScheduledRepository {
  ...
  abstract firstMatching(criteria: Criteria<ScheduledField>): Promise<Nullable<Scheduled>>;
